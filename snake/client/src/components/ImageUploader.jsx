...
function ImageUploader({ userEmail }) {
    ...
    //         const { mimetype, data: bufferData } = data.imageData;

    //         const binaryData = Uint8Array.from(bufferData.data).buffer
    ...
    //         // Assuming bufferData is an array of bytes, convert it to Uint8Array
    //         const binaryData = new Uint8Array(bufferData.data);
